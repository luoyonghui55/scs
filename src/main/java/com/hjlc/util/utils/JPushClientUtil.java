...
public class JPushClientUtil extends BaseController{
	...
	public static final String JPUSH_HOST = "127.0.0.1";
	public static final int JPUSH_PORT = 1668;
	public static final String JPUSH_USER_NAME = "name";
	public static final String JPUSH_USER_PWD = "password";
	/**
	...
	private static void init(){
		...
		clientConfig.setMaxRetryTimes(timeToLive);
		HttpProxy httpProxy = new HttpProxy(JPUSH_HOST, JPUSH_PORT,JPUSH_USER_NAME,JPUSH_USER_PWD);
		jpush = new JPushClient(masterSecret, appKey, httpProxy, clientConfig);
	}
