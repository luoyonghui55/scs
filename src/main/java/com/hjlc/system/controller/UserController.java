...
import com.hjlc.util.utils.GetPinyin;
import com.hjlc.util.utils.ObjectExcelRead;
...
public class UserController extends BaseController {
	...
	public ModelAndView goEditU() throws Exception {
		...
		mv.setViewName(PAGE_PATH_PREFIX + "system/user/user_edit.jsp");
	...
	public ModelAndView listUsers(Page page) throws Exception {
		...
		mv.setViewName(PAGE_PATH_PREFIX + "system/user/user_list.jsp");
	...
	public ModelAndView listtabUsers(Page page) throws Exception {
		...
		mv.setViewName(PAGE_PATH_PREFIX + "system/user/user_tb_list.jsp");
		mv.addObject("userList", userList);
		mv.addObject("pd", pd);
		mv.addObject(Constants.SESSION_QX, this.getHC()); // 按钮权限
		return mv;
	...
	public ModelAndView goUploadExcel() throws Exception {
		ModelAndView mv = this.getModelAndView();
		mv.setViewName(PAGE_PATH_PREFIX + "system/user/uploadexcel.jsp");
		return mv;
	}
	...
	public void downExcel(HttpServletResponse response) throws Exception {
		FileUtil.fileDownload(response, PathUtil.getClasspath() + Constants.FILEPATHFILE + "Users.xls", "Users.xls");
	}
	...
	public ModelAndView readExcel(@RequestParam(value = "excel", required = false) MultipartFile file)
		...
		if (null != file && !file.isEmpty()) {
			...
			String fileName = FileUtil.fileUpload(file, filePath, "userexcel"); // 执行上传
