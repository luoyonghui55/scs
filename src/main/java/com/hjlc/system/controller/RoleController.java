...
public class RoleController extends BaseController {
	...
	public ModelAndView toAdd(Page page){
		...
		try{
			pd = this.getPageData();
			mv.setViewName(PAGE_PATH_PREFIX + "system/role/role_add.jsp");
			mv.addObject("pd", pd);
		} catch(Exception e){
			logger.error(e.toString(), e);
		}
	...
	public ModelAndView toEdit( String ROLE_ID )throws Exception{
		...
		try{
			...
			mv.setViewName(PAGE_PATH_PREFIX + "system/role/role_edit.jsp");
			mv.addObject("pd", pd);
		} catch(Exception e){
			logger.error(e.toString(), e);
		}
	...
	public String auth(@RequestParam String ROLE_ID,Model model)throws Exception{
		...
		return PAGE_PATH_PREFIX + "authorization.jsp";
	}
