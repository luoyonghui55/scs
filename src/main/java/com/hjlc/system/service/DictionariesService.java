package com.hjlc.system.service;
...
public class DictionariesService{
	 ...
	 * @throws Exception
	 */
	public List<PageData> pageDictlistPage(Page page) throws Exception {
		return (List<PageData>) dao.findForList("DictionariesMapper.pageDictlistPage", page);
	}
	//删除
