...
import com.hjlc.information.service.AndorraService;
...
public class AndorraController extends BaseController{
	...
	public ModelAndView listUsers(HttpSession session, Page page) throws Exception{
		...
		try{
			...
			mv.setViewName(PAGE_PATH_PREFIX + "information/andorra/andorra_list.jsp");
	...
	public ModelAndView edit(HttpServletRequest request, @RequestParam(value = "tp", required = false) MultipartFile tp,
			...
			@RequestParam(value = "tourl", required = false) String tourl) throws Exception {
		ModelAndView mv = new ModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
	...
	public ModelAndView save(HttpServletRequest request, @RequestParam(value = "tp", required = false) MultipartFile tp,
			@RequestParam(value = "title", required = false) String title,
			@RequestParam(value = "content", required = false) String content,
			@RequestParam(value = "type", required = false) String type,
			@RequestParam(value = "publisher", required = false) String publisher,
