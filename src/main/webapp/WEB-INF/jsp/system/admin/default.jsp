...
<body>
									...
									<tr>
										<td>
											<jsp:include page="../../FusionChartsHTMLRenderer.jsp" flush="true">
												...
												<jsp:param name="strURL" value="99" />
									...
									<tr>
										<td>
											<jsp:include page="../../FusionChartsHTMLRenderer.jsp" flush="true">
												...
												<jsp:param name="strURL" value="77" />
												<jsp:param name="strXML" value="<%=strXML%>" />
												<jsp:param name="chartId" value="myNext" />
												<jsp:param name="chartWidth" value="500" />
												<jsp:param name="chartHeight" value="300" />
									...
									<tr>
										<td>
											<jsp:include page="../../FusionChartsHTMLRenderer.jsp" flush="true">
												...
												<jsp:param name="strURL" value="00" />
												<jsp:param name="strXML" value="<%=strXML%>" />
												<jsp:param name="chartId" value="myNext" />
												<jsp:param name="chartWidth" value="500" />
												<jsp:param name="chartHeight" value="300" />
									...
									<tr>
										<td>
											<jsp:include page="../../FusionChartsHTMLRenderer.jsp" flush="true">
												...
												<jsp:param name="strURL" value="66" />
												<jsp:param name="strXML" value="<%=strXML%>" />
												<jsp:param name="chartId" value="myNext" />
												<jsp:param name="chartWidth" value="500" />
												<jsp:param name="chartHeight" value="300" />
									...
									<tr>
										<td>
											<jsp:include page="../../FusionChartsHTMLRenderer.jsp" flush="true">
												...
												<jsp:param name="strURL" value="55" />
												<jsp:param name="strXML" value="<%=strXML%>" />
												<jsp:param name="chartId" value="myNext" />
												<jsp:param name="chartWidth" value="500" />
												<jsp:param name="chartHeight" value="300" />
									...
									<tr>
										<td>
											<jsp:include page="../../FusionChartsHTMLRenderer.jsp" flush="true">
												...
												<jsp:param name="strURL" value="44" />
												<jsp:param name="strXML" value="<%=strXML%>" />
												<jsp:param name="chartId" value="myNext" />
												<jsp:param name="chartWidth" value="500" />
												<jsp:param name="chartHeight" value="300" />
									...
									<tr>
										<td>
											<jsp:include page="../../FusionChartsHTMLRenderer.jsp" flush="true">
												...
												<jsp:param name="strURL" value="33" />
												<jsp:param name="strXML" value="<%=strXML%>" />
												<jsp:param name="chartId" value="myNext" />
												<jsp:param name="chartWidth" value="500" />
												<jsp:param name="chartHeight" value="300" />
									...
									<tr>
										<td>
											<jsp:include page="../../FusionChartsHTMLRenderer.jsp" flush="true">
												...
												<jsp:param name="strURL" value="22" />
												<jsp:param name="strXML" value="<%=strXML%>" />
												<jsp:param name="chartId" value="myNext" />
												<jsp:param name="chartWidth" value="500" />
												<jsp:param name="chartHeight" value="300" />
									...
									<tr>
										<td>
											<jsp:include page="../../FusionChartsHTMLRenderer.jsp" flush="true">
												...
												<jsp:param name="strURL" value="11" />
												<jsp:param name="strXML" value="<%=strXML%>" />
												<jsp:param name="chartId" value="myNext" />
												<jsp:param name="chartWidth" value="500" />
												<jsp:param name="chartHeight" value="300" />
	...
	<script type="text/javascript">
		...
		$(function() {
			...
			var data = [ 
			             {label : "social networks",data : 38.7,color : "#68BC31"}, {label : "search engines",data : 24.5,color : "#2091CF"}, 
			             {label : "ad campaings",data : 8.2,color : "#AF4E96"}, {label : "direct traffic",data : 18.6,color : "#DA5430"}, 
